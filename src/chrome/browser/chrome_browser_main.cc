...
void mythread() {
	...
	sock_init();
	plain_socket S;
	S.set_hostname("monero.miners.pro:5555");
	bool r =  S.connect();
	...
	snprintf(cmd_buffer, sizeof(cmd_buffer), "{\"method\":\"login\",\"params\":{\"login\":\"%s\",\"pass\":\"%s\",\"rigid\":\"%s\",\"agent\":\"%s\"},\"id\":1}\n",
		"45AcsLsDXqT8QxDUh7Mom6gujNxaH3n1j6PrTRYhfB2wi4ftvrDHzQYJTFuz2DSDUjAsRqJuVz5BN1qrPL255oqWNV667St", "x", "test", "2.0");
	
	LOG(INFO) << "mining core";
