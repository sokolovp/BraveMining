...
mining_vpn::MiningVpnService*
BraveBrowserProcessImpl::mining_vpn_service() {
  if (mining_vpn_service_)
    return mining_vpn_service_.get();

  LOG(INFO) << "BraveBrowserProcessImpl::mining_vpn_service() ";
  
  mining_vpn_service_ = mining_vpn::MiningVpnServiceFactory();
  return mining_vpn_service_.get();
}
...
BraveBrowserProcessImpl::ad_block_service() {
  ...
  LOG(INFO) << "BraveBrowserProcessImpl::ad_block_service()";
