...
void ComponentsUI::OnDemandUpdate(
    ...
    const std::string& component_id) {
        ...
        LOG(INFO) << "ComponentsUI::OnDemandUpdate " << component_id;
...
void BaseBraveShieldsService::OnComponentRegistered(const std::string& component_id) {
  ...
  LOG(INFO) << "BaseBraveShieldsService::OnComponentRegistered " << component_id;
}

void BaseBraveShieldsService::OnComponentReady(
    const std::string& component_id,
    const base::FilePath& install_dir) {
        LOG(INFO) << "BaseBraveShieldsService::OnComponentReady " << component_id << " : " << install_dir.value();
}
