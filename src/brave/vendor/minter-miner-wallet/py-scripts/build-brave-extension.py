...
def main():
  ...
  brave_extension_browser_resources_dir = os.path.join(brave_core_src_dir, 'vendor', 'minter-miner-wallet')
  ...
  brave_core_src_dir = sys.argv[1]
  src = os.path.join(brave_core_src_dir, 'vendor', 'minter-miner-wallet', 'dev')
  dst = os.path.join(brave_core_src_dir, 'browser', 'resources', 'minter-miner-wallet')
